...
**metadata** | [**array<string,\OpenAPI\Client\Model\CreateWorkflowRunMetadataValue>**](CreateWorkflowRunMetadataValue.md) | Arbitrary key-value metadata attached to the run. Values can be strings or arrays of strings. | [optional]
