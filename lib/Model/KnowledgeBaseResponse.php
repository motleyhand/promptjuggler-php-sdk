...
class KnowledgeBaseResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'KnowledgeBaseResponse';
    ...
    protected static $openAPITypes = [
        'id' => 'string',
        'status' => '\OpenAPI\Client\Model\KnowledgeBaseStatus',
        'documentCount' => 'int',
        'chunkCount' => 'int',
        'documents' => '\OpenAPI\Client\Model\KnowledgeDocumentSummary[]'
    ];
     ...
     * Gets status
     *
     * @return \OpenAPI\Client\Model\KnowledgeBaseStatus
     */
     ...
     * Sets status
     *
     * @param \OpenAPI\Client\Model\KnowledgeBaseStatus $status Processing status
     *
     * @return self
     */
     ...
     * Gets documents
     *
     * @return \OpenAPI\Client\Model\KnowledgeDocumentSummary[]
     */
     ...
     * Sets documents
     *
     * @param \OpenAPI\Client\Model\KnowledgeDocumentSummary[] $documents documents
     *
     * @return self
     */
