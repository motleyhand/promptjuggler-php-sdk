...
class PromptrunsItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function get(?PromptrunsItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [PromptRun::class, 'createFromDiscriminatorValue'], $errorMappings);
    }
    ...
    */
    public function toGetRequestInformation(?PromptrunsItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
