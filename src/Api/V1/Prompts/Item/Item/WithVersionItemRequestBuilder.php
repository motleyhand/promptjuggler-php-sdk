...
class WithVersionItemRequestBuilder extends BaseRequestBuilder 
{
    ...
    */
    public function get(?WithVersionItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): Promise {
        ...
        return $this->requestAdapter->sendAsync($requestInfo, [PromptRevision::class, 'createFromDiscriminatorValue'], null);
    }
    ...
    */
    public function toGetRequestInformation(?WithVersionItemRequestBuilderGetRequestConfiguration $requestConfiguration = null): RequestInformation {
