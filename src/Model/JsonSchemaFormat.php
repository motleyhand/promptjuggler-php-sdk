...
/**
 * JsonSchemaFormat Class Doc Comment
 *
 ...
 */
class JsonSchemaFormat implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static string $openAPIModelName = 'JsonSchemaFormat';
    ...
    public function setName(string $name): static
    {
        ...
        if ((!preg_match("/[a-zA-Z0-9_-]+/", ObjectSerializer::toString($name)))) {
            throw new InvalidArgumentException("invalid value for \$name when calling JsonSchemaFormat., must conform to the pattern /[a-zA-Z0-9_-]+/.");
        }
