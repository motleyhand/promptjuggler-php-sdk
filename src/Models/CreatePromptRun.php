...
class CreatePromptRun implements AdditionalDataHolder, Parsable
{
    ...
    public function getFieldDeserializers(): array
    {
        ...
        return [
            'channel' => static fn (ParseNode $n) => $o->setChannel($n->getStringValue()),
            'environment' => static fn (ParseNode $n) => $o->setEnvironment($n->getStringValue()),
            'envVars' => static fn (ParseNode $n) => $o->setEnvVars(
                $n->getObjectValue([CreatePromptRun_envVars::class, 'createFromDiscriminatorValue']),
            ),
            'inputs' => static fn (ParseNode $n) => $o->setInputs(
                $n->getObjectValue([CreatePromptRun_inputs::class, 'createFromDiscriminatorValue']),
            ),
            'metadata' => static fn (ParseNode $n) => $o->setMetadata(
                $n->getObjectValue([CreatePromptRun_metadata::class, 'createFromDiscriminatorValue']),
            ),
            'priority' => static fn (ParseNode $n) => $o->setPriority(
                $n->getEnumValue(CreatePromptRun_priority::class),
            ),
            'thread' => static fn (ParseNode $n) => $o->setThread($n->getStringValue()),
        ];
    }
