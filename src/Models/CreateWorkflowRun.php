    ...
    public function getFieldDeserializers(): array
    {
        ...
        return [
            ...
            'envVars' => static fn (ParseNode $n) => $o->setEnvVars(
                $n->getObjectValue([CreateWorkflowRun_envVars::class, 'createFromDiscriminatorValue']),
            ),
            'inputs' => static fn (ParseNode $n) => $o->setInputs(
                $n->getObjectValue([CreateWorkflowRun_inputs::class, 'createFromDiscriminatorValue']),
            ),
            'metadata' => static fn (ParseNode $n) => $o->setMetadata(
                $n->getObjectValue([CreateWorkflowRun_metadata::class, 'createFromDiscriminatorValue']),
            ),
            'priority' => static fn (ParseNode $n) => $o->setPriority(
                $n->getEnumValue(CreateWorkflowRun_priority::class),
            ),
