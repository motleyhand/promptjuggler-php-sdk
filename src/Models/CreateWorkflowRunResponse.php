...
class CreateWorkflowRunResponse implements AdditionalDataHolder, Parsable
{
    ...
    /**
     * Instantiates a new CreateWorkflowRunResponse and sets the default values.
     */
     ...
     */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): CreateWorkflowRunResponse
    {
