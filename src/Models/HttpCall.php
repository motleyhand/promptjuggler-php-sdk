    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'headers' => fn(ParseNode $n) => $o->setHeaders($n->getCollectionOfObjectValues([HttpHeader::class, 'createFromDiscriminatorValue'])),
            'method' => fn(ParseNode $n) => $o->setMethod($n->getEnumValue(HttpCall_method::class)),
            'name' => fn(ParseNode $n) => $o->setName($n->getStringValue()),
            'paramsSchema' => fn(ParseNode $n) => $o->setParamsSchema($n->getStringValue()),
            'type' => fn(ParseNode $n) => $o->setType($n->getEnumValue(HttpCall_type::class)),
