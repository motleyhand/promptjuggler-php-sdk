...
class JsonSchemaFormat implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'schema' => fn(ParseNode $n) => $o->setSchema($n->getStringValue()),
            'strict' => fn(ParseNode $n) => $o->setStrict($n->getBooleanValue()),
            'type' => fn(ParseNode $n) => $o->setType($n->getEnumValue(JsonSchemaFormat_type::class)),
        ];
    }
    ...
    */
     ...
     * @return JsonSchemaFormat_type|null
    */
