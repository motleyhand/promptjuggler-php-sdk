...
class KnowledgeBaseResponse implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'chunkCount' => fn(ParseNode $n) => $o->setChunkCount($n->getIntegerValue()),
            'documentCount' => fn(ParseNode $n) => $o->setDocumentCount($n->getIntegerValue()),
            'documents' => fn(ParseNode $n) => $o->setDocuments($n->getCollectionOfObjectValues([KnowledgeDocumentSummary::class, 'createFromDiscriminatorValue'])),
            'id' => fn(ParseNode $n) => $o->setId($n->getStringValue()),
            'status' => fn(ParseNode $n) => $o->setStatus($n->getEnumValue(KnowledgeBaseStatus::class)),
        ];
    }
    ...
    */
     ...
     * @return KnowledgeBaseStatus|null
    */
