...
class KnowledgeSearch implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'knowledgeBaseId' => fn(ParseNode $n) => $o->setKnowledgeBaseId($n->getStringValue()),
            'name' => fn(ParseNode $n) => $o->setName($n->getStringValue()),
            'type' => fn(ParseNode $n) => $o->setType($n->getEnumValue(KnowledgeSearch_type::class)),
        ];
    }
    ...
    */
     ...
     * @return KnowledgeSearch_type|null
    */
