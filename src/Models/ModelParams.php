...
class ModelParams implements AdditionalDataHolder, Parsable 
{
    ...
    */
    public function getFieldDeserializers(): array {
        $o = $this;
        return  [
            'maxCompletionTokens' => fn(ParseNode $n) => $o->setMaxCompletionTokens($n->getIntegerValue()),
            'reasoningEffort' => fn(ParseNode $n) => $o->setReasoningEffort($n->getEnumValue(ModelParams_reasoningEffort::class)),
            'reasoningSummary' => fn(ParseNode $n) => $o->setReasoningSummary($n->getBooleanValue()),
            'serviceTier' => fn(ParseNode $n) => $o->setServiceTier($n->getObjectValue([ModelParams_serviceTier::class, 'createFromDiscriminatorValue'])),
            'temperature' => fn(ParseNode $n) => $o->setTemperature($n->getFloatValue()),
            'topP' => fn(ParseNode $n) => $o->setTopP($n->getFloatValue()),
            'verbosity' => fn(ParseNode $n) => $o->setVerbosity($n->getEnumValue(ModelParams_verbosity::class)),
        ];
    }
    ...
    */
     ...
     * @return ModelParams_reasoningEffort|null
    */
    ...
    */
     ...
     * @return ModelParams_serviceTier|null
    */
    ...
    */
     ...
     * @return ModelParams_verbosity|null
    */
