    ...
    */
    public function getFieldDeserializers(): array {
        ...
        return  [
            ...
            'memory' => fn(ParseNode $n) => $o->setMemory($n->getEnumValue(Memory::class)),
            'messages' => fn(ParseNode $n) => $o->setMessages($n->getCollectionOfObjectValues([ContentMessageResponse::class, 'createFromDiscriminatorValue'])),
            'model' => fn(ParseNode $n) => $o->setModel($n->getEnumValue(Model::class)),
            'modelParams' => fn(ParseNode $n) => $o->setModelParams($n->getObjectValue([ModelParams::class, 'createFromDiscriminatorValue'])),
            'promptId' => fn(ParseNode $n) => $o->setPromptId($n->getStringValue()),
            'provider' => fn(ParseNode $n) => $o->setProvider($n->getEnumValue(Provider::class)),
            'responseFormat' => fn(ParseNode $n) => $o->setResponseFormat($n->getObjectValue([ResponseFormat::class, 'createFromDiscriminatorValue'])),
            'systemInstruction' => fn(ParseNode $n) => $o->setSystemInstruction($n->getStringValue()),
            'tools' => fn(ParseNode $n) => $o->setTools($n->getCollectionOfObjectValues([Tool::class, 'createFromDiscriminatorValue'])),
        ];
    }
