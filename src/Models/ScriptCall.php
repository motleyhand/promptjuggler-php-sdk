...
class ScriptCall implements AdditionalDataHolder, Parsable
{
    ...
    public function getFieldDeserializers(): array
    {
        ...
        return [
            'code' => static fn (ParseNode $n) => $o->setCode($n->getStringValue()),
            ...
            'language' => static fn (ParseNode $n) => $o->setLanguage($n->getEnumValue(ScriptCall_language::class)),
            'name' => static fn (ParseNode $n) => $o->setName($n->getStringValue()),
            'type' => static fn (ParseNode $n) => $o->setType($n->getEnumValue(ScriptCall_type::class)),
        ];
    }
