 ...
 */
class VersionRef_idOrTag implements ComposedTypeWrapper, Parsable
{
    /**
     ...
     */
    public static function createFromDiscriminatorValue(ParseNode $parseNode): VersionRef_idOrTag
    {
        $result = new VersionRef_idOrTag();
        if ($parseNode->getIntegerValue() !== null) {
            $finalValue = $parseNode->getIntegerValue();
            $result->setInteger($finalValue);
        } elseif ($parseNode->getStringValue() !== null) {
